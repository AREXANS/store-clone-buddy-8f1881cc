...
const Admin = () => {
  ...
  const paymentKeys = ['cashify_license_key', 'cashify_qris_id', 'cashify_webhook_key', 'cashify_api_key', 'discord_webhook_url', 'payment_mode', 'payment_simulation', 'fonnte_token', 'xcoins_enabled', 'xcoins_only', 'xcoins_logo_url'];
